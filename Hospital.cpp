/*=========================================================================================
 Name        : Hospital Patient Queue Management System
 Author      : Mostafa Galib
 Version     : 1.0.1
 Copyright   : 2024 Mostafa Galib. All rights reserved.
 Description : The Hospital Patient Queue Management System is a C++ application designed to
			   manage patient data in a hospital setting using a priority queue.
			   The system allows for the addition of new patients, prioritizing them
			   based on the urgency of their medical needs (Emergency, Follow up, General),
			   and facilitates the removal and display of patients in the queue.
==========================================================================================*/
